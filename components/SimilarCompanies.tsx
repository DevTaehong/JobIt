...
return(
<div className="inline-flex flex-col font-manrope justify-center items-start p-[1.25rem] rounded-[0.625rem] gap-[1.25rem] shadow-[0_6px_14px_0_rgba(23,23,37,0.02)] bg-white
dark:bg-DarkBG2 ">
...
<div className=" text-black text-[1.00rem] not-italic font-semibold leading-6
dark:text-White ">{props.JobTitle}</div>
<div className="text-Natural6  text-[0.875rem] not-italic font-medium leading-5">{props.JobTitleSec}</div>
</div>
    </div>
