...
const Navbar = () => {
  ...
  return (
    <header>
      <nav className="flex h-[3.875rem] w-full shrink-0 items-center justify-between gap-[0.625rem] border-b border-solid border-Natural5 bg-White px-6 py-[1.125rem] dark:border-DarkBG3 dark:bg-DarkBG1 lg:h-[4.375rem] lg:px-20 lg:py-0">
        {/* Mobile navigation */}
        <Sheet
          open={open}
