...
1. Clone the repo
   ...
   ```shell
    git clone https://github.com/JavaScript-Mastery-PRO/Cohort5_BreakingBugs_JobIt.git
   ```

2. Change directory to the project directory

   ```shell
   cd Cohort5_BreakingBugs_JobIt
   ```
...
4. Go to [Pull Requests](https://github.com/JavaScript-Mastery-PRO/Cohort5_BreakingBugs_JobIt/pulls) and click on the `New Pull Request` button.
